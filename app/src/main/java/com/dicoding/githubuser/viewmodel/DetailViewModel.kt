...
class DetailViewModel: ViewModel() {
    // LiveData untuk data detail pengguna
    private val _detailUser = MutableLiveData<DetailUserResponse>()
    val detailUser: LiveData<DetailUserResponse> = _detailUser

    // LiveData untuk daftar pengikut
    private val _followers = MutableLiveData<List<ItemsItem>>()
    val followers: LiveData<List<ItemsItem>> = _followers

    // LiveData untuk daftar yang diikuti
    ...
    // Fungsi untuk mengatur detail pengguna berdasarkan ID
    fun setDetailUser(detailUserId: String) {
        DETAILUSER_ID = detailUserId
        findDetailUserResponse()
    }

    // Fungsi untuk mendapatkan data detail pengguna dari API
